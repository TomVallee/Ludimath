        ...
        <body>
            ...
            ?>
                    <div class="container">
                        ...
                        <div class="well">
                            <center>
                                <h2>Qu'est ce que c'est ?</h2></center>
                            <p>La création d'un site web permettant de réaliser des exercices de mathématiques tout en y incluant des aspects ludifiants a pour but de permettre un meilleur apprentissage de la part des étudiants de l'ENSC ayant des difficultés en mathématiques au début de l'année. De plus, la ludification du parcours différencié de mathématiques augmente les interactions entre les étudiants; ainsi, cela facilite l'integration des élèves au début de l'année et améliore l'entente et le bien être de la promotion à venir.</p>
                        </div>
                        <div class="well">
                            <center>
                                <h2>Point environnemental (loi Grenelle)</h2></center>
                            <p>Il est également à prendre en compte que la réalisation d'exercices de mathématiques sur ordinateur se place dans la continuité du virage pris par l'Education Nationale dans la numérisation des outils pédagogiques, ce qui diminue ainsi la consommation de papier et donc l'impact écologique de l'enseignement supérieur.</p>
                        </div>
                    </div>
            </div>
