    ...
    <body>
        <div id="wrap">
            ...
            <div class="container">
                ...
                <div class="well">
                    <center><h2>Point environnemental (loi Grenelle)</h2></center>
                    <p>Il est également à prendre en compte qu'augmenter la réalisation des exercices de mathématiques sur ordinateur se place dans la continuité du virage pris par l'Education Nationale dans la numérisation des outils pédagogiques, et ainsi diminuer la consommation de papier et donc l'impact écologique de l'enseignement supérieur.</p>
                </div>
            </div>
        </div>
