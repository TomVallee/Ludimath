    ...
    <body>
        <div class="container">
            ...
            <ul class="nav nav-tabs">
                ...
                {
                    echo"</br>";
                    echo"\t Né dans les années 780, Muhammad Ibn Mūsā al-Khuwārizmī propose la première approche systématique des équations de second et de premier degré. Son oeuvre est à l’origine de l’utilisation des chiffres arabes en Europe et au Moyen-Orient."; 
                ...
                {
                    echo"</br>";
                    echo"\t Né en 1815, Karl Weierstrass est un mathématicien Allemand du XIXème siècle. Il est considéré comme l’un des pères de “l’analyse moderne”. Il terminera les 3 dernières années de sa vie immobile, et meurt à Berlin en 1897.";
                    echo"</br>";echo"</br>";echo"Succes associé : ";
